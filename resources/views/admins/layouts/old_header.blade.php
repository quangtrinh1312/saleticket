<div class="navbar navbar-expand-lg navbar-dark navbar-static">
		...
		<div class="navbar-brand text-center text-lg-left">
			<a href="/" class="d-inline-block">
				<!-- <img src="{{asset('global_assets/images/logo_qlnhadn.png')}}" style="width: 50px; height: 50px;" class="d-none d-sm-block" alt=""> -->
			</a>
		</div>
		...
		<ul class="navbar-nav flex-row order-1 order-lg-2 flex-1 flex-lg-0 justify-content-end align-items-center">
			...
			<li class="nav-item nav-item-dropdown-lg dropdown dropdown-user h-100">
				<a href="#" class="navbar-nav-link navbar-nav-link-toggler dropdown-toggle d-inline-flex align-items-center h-100" data-toggle="dropdown">
					<img src="{{asset('global_assets/images/logo_qlnhadn.png')}}" class="rounded-pill mr-lg-2" height="34" alt="">
					<span class="d-none d-lg-inline-block">Cài đặt</span>
				</a>

				<div class="dropdown-menu dropdown-menu-right">
					<button type="button" class="dropdown-item" id="btn_show_infor" value="{{ Auth::guard('account')->user() ? Auth::guard('account')->user()->id : '' }}" onclick="showModalInfor(event, this, '{{ route('personal-infor.edit', ':id') }}', '{{ route('personal-infor.update', ':id') }}', '{{ csrf_token() }}')">
                        <i class="fa-solid fa-user"></i>
                        Thông tin cá nhân
                    </button>
                    <button type="button" class="dropdown-item" id="btn_change_pwd" value="{{ Auth::guard('account')->user() ? Auth::guard('account')->user()->id : '' }}" onclick="showModal(event)">
                        <i class="fa-solid fa-key"></i>
                        Đổi mật khẩu
                    </button>
                    <a href="{{route('configure.receipt.detail.type', ['type_receipt_id' => 3, 'url' => url()->full()])}}" class="dropdown-item"><i class="fa-solid fa-gear"></i></i> Cấu hình hóa đơn</a>
                    <a href="{{route('configure.receipt.detail.type', ['type_receipt_id' => 1, 'url' => url()->full()])}}" class="dropdown-item"><i class="fa-solid fa-gear"></i></i> Cấu hình biên lai</a>
                    <a href="{{route('get.admin.logout')}}" class="dropdown-item"><i class="icon-switch2"></i> Đăng xuất</a>
				</div>
			</li>
		</ul>
	</div>

    {{-- Modal Show thông tin cá nhân --}}
    <div class="modal fade" id="modal_show_infor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body pt-2 pb-2">
                    <form action="" id="form_show_infor">
                        <div class="row mb-2">
                            <div class="col-3"></div>
                            <div class="col-9">
                                <button type="button" class="btn btn-success btn-sm" id="i_btn_enable">Thay đổi</button>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control form-control-sm" id="i_fullname_edit" maxlength="50" disabled>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control form-control-sm" id="i_username_edit" disabled>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                            ...
                            <div class="col-9">
                                <input type="email" class="form-control form-control-sm" id="i_email_edit" maxlength="191" disabled>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                            ...
                            <div class="col-9">
                                <input type="text" class="form-control form-control-sm" id="i_phone_number_edit" maxlength="20" disabled>
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-success btn-sm d-none" id="i_btn_update" style="margin-left: 0.5rem !important;">Cập nhật</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal fade" id="modal_change_pwd" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form action="" id="form_change_pwd">
                        <div class="row">
                            <div class="col-3">
                                <label for="" class="col-form-label-sm float-right">Mật khẩu hiện tại:</label>
                            </div>
                            <div class="col-9">
                                <input type="password" class="form-control form-control-sm" id="curr_pwd">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-3">
                                <label for="" class="col-form-label-sm float-right">Mật khẩu mới:</label>
                            </div>
                            <div class="col-9">
                        ...
                        <div class="row">
                            <div class="col-3">
                                <label for="" class="col-form-label-sm float-right">Xác nhận mật khẩu:</label>
                            </div>
                            <div class="col-9">
                                <input type="password" class="form-control form-control-sm" id="confirm_pwd">
                            </div>
                        </div>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-outline-secondary btn-sm" data-dismiss="modal">Đóng</button>
                    <button type="button" class="btn btn-success btn-sm" id="btn_confirm" style="margin-left: 0.5rem !important;" onclick="confirmChangePwd(event, this, '{{ route('change.pwd') }}', '{{ csrf_token() }}')">Xác nhận</button>
                </div>
            </div>
        </div>
    </div>
