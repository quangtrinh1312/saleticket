<div class="modal fade" id="createTicketModal" tabindex="-1" role="dialog" aria-labelledby="createTicketLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="createTicketLabel">Thêm mới loại vé</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="input-group-text">Tính trước thuế</button>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        ...
                        <div class="input-group">
                            <input type="number" name="pre_tax_price" id="pre_tax_price" class="form-control" readonly>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-5">
