<div>
    <div wire:ignore.self class="modal fade" id="modal_update_household" role="dialog" aria-labelledby="exampleModalLabel_update" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel_update">Sửa Hộ dân</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body" id="update_content_household">
                    <form wire:submit.prevent="update">
                        <div class="row pb-3">
                            ...
                            <div class="col-9 mt-3">
                                <div wire:ignore>
                                    <select class="custom-select select-update" id="select-room-update">
                            ...
                            <div class="col-9 mt-3">
                                <div wire:ignore>
                                    <select class="custom-select select-update" id="select-district-update">
                            ...
                            <div class="col-9 mt-3">
                                <div wire:ignore>
                                    <select class="custom-select select-update" id="select-ward-update">
                            ...
                            <div class="col-9 mt-3">
                                <div wire:ignore>
                                    <select class="custom-select select-update" id="select-account-update">
                            ...
                            <div class="col-9 mt-3">
                                <div wire:ignore>
                                    <select class="custom-select select-update" id="select-status-update">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="submit" class="btn btn-primary btn-sm" style="margin-left: 0.5rem !important;">Lưu</button>
                        </div>
                    </form>
                </div>
            </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#select-room-update').on('change', function(e) {
            var value = $('#select-room-update').select2("val");
            @this.set('roomId', value);
        })

        $('#select-district-update').on('change', function(e) {
            var value = $('#select-district-update').select2("val");
            @this.set('districtId', value);
        })

        $('#select-ward-update').on('change', function(e) {
            var value = $('#select-ward-update').select2("val");
            @this.set('wardId', value);
        })

        $('#select-account-update').on('change', function(e) {
            var value = $('#select-account-update').select2("val");
            @this.set('accountId', value);
        })

        $('#select-status-update').on('change', function(e) {
            var value = $('#select-status-update').select2("val");
            @this.set('statusId', value);
        })
    });

    window.addEventListener('openUpdateHouseHold', () => {
        $('#modal_update_household').modal('show');
    })

    window.addEventListener('closeUpdateHouseHold', () => {
        $('#modal_update_household').modal('hide');
    })
