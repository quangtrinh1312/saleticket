        ...
        <div class="container mb-2">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('paradigms-blocks.index', ['paradigm_id' => 1])}}" method="GET">
                        @method('GET')
                        @csrf
            ...
            <div class="mt-3">
                <div class="d-flex justify-content-between">
                    ...
                    <div>
                        <button type="button" class="btn btn-info btn-sm" id="modal_create_block_btn">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('paradigms-blocks.store', ['paradigm_id' => 1])}}" method="POST">
                                @method('POST')
                                @csrf
                                <div class="row">
                                    <div class="col-3">
            ...
            <div class="modal fade" id="modal_update_block" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel_update" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
...
<script>
    $(document).ready(function() {
        $(document).off('click', '#modal_create_block_btn').on('click', '#modal_create_block_btn', function(e) {
            e.preventDefault();
            $('#modal_create_block').modal('show');
        });
    });
    


    function getBlock(paradigm_id, id, url) {

        $('#modal_update_block').modal('show');

        let content_modal_update_block =  $('#update_content_block');
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-blocks.edit','id')}}',

            success: function (data) {

                content_modal_update_block.html(data);
