        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.apartment.collect')}}" method="GET">
                    	@method('GET')
                    	@csrf
                    	<div class="row">
                    		<div class="col-lg-6">
            ...
            <div class="collect mt-3">
            	<fieldset class="scheduler-border embed-responsive overflow-auto">
                    ...
                    <form action="{{route('post.paradigms.apartment.collect')}}" method="POST" >
                    	@csrf
                    	@method('POST')
                    	<div class="row">
                    		<div class="col-lg-6">
                    		...
                    		<div class="col-lg-6">
	                                <div class="form-group">
	                                    <div class="row align-items-center">
	                                        ...
	                                        <div class="col-8">
	                                            <input type="text" class="form-control" id="input_fullname" name="fullname" value="{{old('fullname') ?? $householdInformation->fullname}}" onkeyup="validateForm()" onchange="validateForm()">
