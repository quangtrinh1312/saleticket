    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="alpaca_advanced.html" class="breadcrumb-item active">Lịch sử thu tiền</a>
        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.apartment.history',  ['paradigm_id' => 1])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
                            <div class="col-6">
            ...
            <div class="mt-1 text-center">
                @if ($errors)
                    <span class="text-danger k-error text-center">{{ $errors->first()}}</span>
                @endif
            </div>
                    ...
                    <table class="table table-hover table-dark table-striped mb-1 table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center" style="width: 150px !important;">Đã nộp tiền kế toán</th>
                        ...
                        <tbody id="list_accountant_table_data">
                            ...
                            <tr id="r_id_">
                                ...
                                <td scope="row" class="text-center">{{$amountReceived_1_->send_accountant == 1 ? 'Đã nộp' : ''}}</td>
                                <td scope="row" class="text-center">
                                	...
                                	<!-- <form action="{{route('paradigms-apartments.destroy',['id' => $apartment->id, 'paradigm_id' => 1])}}"
                                  	class="float-right"
                                  	method="POST">
		                                @csrf
		                                @method('DELETE')
		                            ...
		                            <a  class="badge badge-primary" id="btn_update_apartment" onclick="getApartment('{{$paradigm_id}}', '{{$amountReceived_1_->id}}', '{{url()->full()}}')" title="Điều chỉnh PT/HĐ/BL" disabled><i class="icon-pencil" aria-hidden="true"></i></a>
                                    @endif
...
<script type="">
    ...
    function getApartment(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-apartments.collect.edit','id')}}',
    ...
    function getDetail(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-apartments.collect.detail','id')}}',
