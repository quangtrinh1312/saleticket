        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.apartment.statistical', ['paradigm_id' => 1])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
                            <div class="col-6">
            ...
            <a href="{{ route('get.paradigms.export.excel', ['paradigm_id' => 1, 'params' => $params]) }}" class="btn btn-success btn-sm">
            ...
            <div class="mt-1 row">
                <div class="col-lg-12">
                    ...
                    <form action="{{route('confirm.send.accountant')}}" method="POST">
                    @method('POST')
                    @csrf
                    <input type="text" name="paradigm_id" value="{{$paradigm_id ?? 0}}" hidden>
                        ...
                        <tbody id="list_accountant_table_data">
                            ...
                            <tr id="r_id_">
                                ...
                                <td scope="row">
                                    ...
                                    @if ($amountReceived_1_->send_accountant == 1)
                                        <a href="{{route('paradigms-apartments.collect.cancel.send.accountant',['id' => $amountReceived_1_->id, 'paradigm_id' => 1])}}" class="badge badge-danger "
                                ...
                                <td scope="row" class="text-center">
                                    ...
                                    <a href="{{route('paradigms-apartments.collect.delete',['id' => $amountReceived_1_->id])}}" class="badge badge-danger "
                                                onclick="if(!confirm('Bạn có chắc chắn muốn hủy ?')){return false}" >
                                            <i class="icon-cross"></i></a>
                                    @endif
                                </td>
