    ...
    <table class="table table-hover table-dark table-bordered table-striped mb-1 table-responsive-lg">
        <thead>
            ...
            <th scope="col" class="text-center">Số lượng nhà
                <a href="{{route('paradigms-blocks.index',['paradigm_id' => 1])}}" class="float-left mr-1"><i class="far fa-eye"></i>
                            </a>
            </th>
            <th scope="col" class="text-center">Số lượng tầng
                <a href="{{route('paradigms-floors.index',['paradigm_id' => 1])}}" class="float-left mr-1"><i class="far fa-eye"></i>
                                </a>
            </th>
