    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="" class="breadcrumb-item">Các khoản thu khác</a>
    ...
    <div class="card mb-4">
        <div class="container mb-2">
            ...
            <div class="mt-2 d-flex justify-content-between">
                <div>
                    <select name="" class="custom-select custom-select-sm" id="tp_row">
            ...
            <div id="list_type_price_table">
                @include('admins.paradigms.other-amount.amount-received.type-price.pagination')
            </div>
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" id="tp_form_create">
                                ...
                                <div class="row">
                                    <div class="col-3">
                                        <label for="" class="col-form-label-sm float-right">Quản lí viên:</label>
                                    </div>
                                    <div class="col-9">
                                        <select name="" id="account_create" class="form-control custom-select custom-select-sm">
                        ...
                        <div class="modal-body">
                            <form action="" id="tp_form_edit">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-9">
                                        <select name="" id="account_edit" class="form-control custom-select custom-select-sm">
                                        </select>
                                    </div>
                                </div>
                            </form>
...
<script>
    ...
    let routeStore = "{{ route('post.paradigms.other.amount.type.price') }}";
    let routeEdit = "{{ route('edit.paradigms.other.amount.type.price', ':id') }}";
    let routeUpdate = "{{ route('update.paradigms.other.amount.type.price', ':id') }}";
    let routeDestroy = "{{ route('destroy.paradigms.other.amount.type.price', ':id') }}";
    let routeGetRow = "{{ route('get.row.paradigms.other.amount.type.price') }}";
    let route = {
        store: routeStore,
        edit: routeEdit,
        update: routeUpdate,
