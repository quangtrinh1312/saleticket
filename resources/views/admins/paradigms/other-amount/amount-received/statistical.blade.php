    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="alpaca_advanced.html" class="breadcrumb-item">Các khoản thu khác</a>
        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.other.amount.statistical', ['url' => url()->full(), 'paradigm_id' => 9])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
            ...
            <a href="{{ route('get.paradigms.export.excel', ['paradigm_id' => 9, 'params' => $params]) }}" class="btn btn-success btn-sm">
                        ...
                        <tbody id="list_accountant_table_data">
                            ...
                            <tr id="r_id_">
                                ...
                                <td scope="row">
                                    ...
                                    @if ($amountReceived_1_->send_accountant == 1)
                                        <a href="{{route('paradigms-apartments.collect.cancel.send.accountant',['id' => $amountReceived_1_->id, 'paradigm_id' => 9])}}" class="badge badge-danger "
                                ...
                                <td scope="row" class="text-center">                                        
                                    ...
                                    <a href="{{route('paradigms-other.amount.collect.delete',['id' => $amountReceived_1_->id])}}" class="badge badge-danger "
                                                onclick="if(!confirm('Bạn có chắc chắn muốn hủy ?')){return false}" >
                                            <i class="icon-cross"></i></a>
                                    @endif
                                </td>
