        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.other.amount.collect')}}" method="GET">
                    	@method('GET')
                    	@csrf
                    	<div class="row">
                    		<div class="col-lg-6">
                    		...
                    		<div class="col-lg-6">
	                                <div class="form-group">
	                                    <div class="row align-items-center">
	                                        ...
	                                        <div class="col-8">
	                                            <input type="text" class="form-control" name="street" value="{{old('street')}}" placeholder="Nguyễn Công Hoan" required>
	                                        </div>
	                                    </div>
	                                </div>
                    		</div>
                    		...
                    		<div class="col-lg-6">
	                                <div class="form-group">
	                                    <div class="row align-items-center">
	                                        ...
	                                        <div class="col-8">
	                                            <input type="text" class="form-control" name="apartment_number" value="{{old('apartment_number')}}" placeholder="K111/12" required>
	                                        </div>
	                                    </div>
	                                </div>
                    		</div>
