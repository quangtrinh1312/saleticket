				...
				<div class="col-lg-12">
					...
					<div class="col-lg-12 mt-4">
						...
						<div class="row pl-2 pr-2">
							...
							@if (isset($household_shnn_type) && $household_shnn_type == 1)

								<a href="{{route('get.paradigms.apartment.house.sell.shnn.collect', ['paradigm_id' => 4])}}" class="btn btn-primary">Quay về</a>
							@else

								<a href="{{route('get.paradigms.address.house.sell.shnn.collect', ['paradigm_id' => 4])}}" class="btn btn-primary">Quay về</a>
							...
							<a href="{{$url}}" class="btn btn-outline-success">Thu tiếp</a>
							 ...
							 style:'#printJS-bill{width:90%; margin:auto; margin-top: 20px; font-size: 24px;} .header-bill{width: 100%;} .mau_so{margin-top:20px; position: relative; text-align: center;} .font-weight-bold{font-weight:bold;} .phieuthu{margin-top:20px;text-align: center;} .col-lg-12{width:100%;} .content_bill{width:100%;e} .box-wrap {width:100%; display: flex ; justify-content: space-between;flex-wrap: wrap;}.box-wrap .left-info {width: max-content; }.box-wrap .right-info {width: max-content;padding-left: 15px; text-align:left; } .right-info .title-row {text-align:left; padding-left: -20px;} .ngaythang{text-align: right;} .nguoilap_phieu{margin-top:50px;text-align: center;} #myContentEditableDiv:first-letter {text-transform: capitalize;} .light-small{margin-top: -36px;} .light-medium{margin-top: -20px;} .header_receipt{width:100%!important; text-align:center; } .header_receipt_p{margin-top: -12px;}.light-margin-top-6px{margin-top: -6px;} .light-small-bottom{margin-bottom: -40px;} image{width: 70%; position: absolute; top: 50%; transform: translateY(-50%); opacity: 0.2; z-index: -9999; left: 14%;}'})">
							    In
							 </button>
						</div>
