        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.house.sell.shnn.history', ['url' => url()->full(), 'paradigm_id' => 9])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
                            <div class="col-lg-6">
                            ...
                            <div class="col-6">
                                <div class="form-group">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-8">
                                            <select name="account_id_for" class="form-control">
                                                <option value="">Tất cả</option>
                    ...
                    <table class="table table-hover table-dark table-striped mb-1 table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center" style="width: 150px !important;">KT đã duyệt</th>
                        ...
                        <tbody id="list_accountant_table_data">
                            ...
                            <tr id="r_id_">
                                ...
                                <td scope="row" class="text-center">{{$amountReceived_1_->send_accountant == 1 ? 'Duyệt' : ''}}</td>
                                <td scope="row">
                                    ...
                                    @if ($amountReceived_1_->parent_id == 0)
...
<script type="">
    ...
    function getDetail(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-other.amount.collect.detail','id')}}',
