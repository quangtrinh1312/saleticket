        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.house.sell.shnn.statistical', ['url' => url()->full(), 'paradigm_id' => 9])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-8">
                                                <input type="text" class="form-control" name="apartment_number" placeholder="Nguyễn Công Hoang">
                                            </div>
                                        </div>
                                    </div>
                            </div>
                            ...
                            <div class="col-lg-6">
                                    <div class="form-group">
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-8">
                                                <input type="text" class="form-control" name="street" placeholder="K111/12">
                                            </div>
                                        </div>
                                    </div>
                            </div>
                                            ...
                                            <select name="account_id" class="custom-select">
                                                @if ($accounts && count($accounts) > 0)
                                                    @foreach ($accounts as $account)
                                                        <option class="option_account" value="{{$account->id}}" {{isset($params['account_id']) ? $params['account_id'] == $account->id ? 'selected' : '' : ''}}>{{$account->fullname}}</option>
                                                    @endforeach
                                                @endif
                                            </select>
                                        </div>
                                ...
                                <div class="form-group">
                                    <div class="row align-items-center">
                                        ...
                                        <div class="col-8">
                                            ...
                                            <button type="reset" class="btn btn-warning btn-sm" id="">
            ...
            <div class="mt-1 row">
                <div class="col-lg-12">
                    ...
                    <form action="{{route('confirm.send.accountant.other.amount')}}" method="POST">
                    @method('POST')
                    @csrf
                    <input type="text" name="paradigm_id" value="{{$paradigm_id ?? 0}}" hidden>
                    ...
                    <table class="table table-hover table-dark table-striped mb-1 table-bordered">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" class="text-center" style="width: 250px !important;">Nội dung nợ tháng</th>
                        ...
                        <tbody id="list_accountant_table_data">
                            ...
                            <tr id="r_id_">
                                <td scope="row">
                                    <input type="checkbox" name="ids[]" class="check_box item" id="" value="{{$amountReceived_1_->id}}" style="cursor: pointer;">
                                </td>
                                <td scope="row">{{$key + 1}}</td>
                                <td scope="row">{{$amountReceived_1_->apartment_number}} {{$amountReceived_1_->street}}, {{$amountReceived_1_->district->name}}, {{$amountReceived_1_->ward->name}}</td>
                                ...
                                <td scope="row" class="text-center">
                                    {{$amountReceived_1_->status == 0 ? 'Đã phát hành PT/BL/HĐ' : 'Điều chỉnh PT/BL/HĐ'}}
                                ...
                                <td scope="row"></td>
                                <td scope="row">{{$amountReceived_1_->send_accountant == 1 ? 'Đã nộp KT' : ''}}</td>
                            </tr>
                            @endforeach
                            @endif
                        </tbody>
