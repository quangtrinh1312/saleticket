@if($edit === 1) 
    ...
    <form action="{{route('paradigms-apartments.house.sell.shnn.collect.edit.post',['id' => $amountReceived7->id])}}" method="POST">
        @method('PUT')
        @csrf
        <div class="row">
            <div class="col-3">
        ...
        <div class="modal-footer">
            <input type="text" name="household_type" value="{{$household_type}}" hidden>
