    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="alpaca_advanced.html" class="breadcrumb-item active">Thu tiền (Địa chỉ)</a>
        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.address.house.sell.shnn.collect')}}" method="GET">
                    	@method('GET')
                    	@csrf
                    	<div class="row">
                    		<div class="col-lg-6">
...
<!-- 				            <th scope="col" class="text-center">Khu chung cư</th>
            ...
            <div class="collect mt-3">
            	<fieldset class="scheduler-border embed-responsive overflow-auto">
                    ...
                    <form action="{{route('post.paradigms.address.house.sell.shnn.collect')}}" method="POST" >
                    	@csrf
                    	@method('POST')
                    	<div class="row">
                    		<div class="col-lg-6">
                    		...
                    		<div class="col-lg-6">
	                                ...
	                                <div class="form-group">
	                                    <div class="row align-items-center">
			                        		...
			                        		<input type="text" name="url" value="{{url()->full()}}" hidden>
                                    		<input type="text" name="paradigm_id" value="{{$paradigm_id ?? 0}}" hidden>
                                    		<input type="text" name="household_shnn_type" value="2" hidden>
