    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="alpaca_advanced.html" class="breadcrumb-item">Nhà dân</a>
        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.people.house.statistical', ['paradigm_id' => 2])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
            ...
            <a href="{{ route('get.paradigms.export.excel', ['paradigm_id' => 2, 'params' => $params]) }}" class="btn btn-success btn-sm">
            ...
            <div class="mt-1 row">
                <div class="col-lg-12">
                    ...
                    <form action="{{route('confirm.send.accountant.people.house')}}" method="POST">
                    @method('POST')
                    @csrf
                    <input type="text" name="paradigm_id" value="{{$paradigm_id ?? 0}}" hidden>
                        ...
                        <tbody id="list_accountant_table_data">
                            ...
                            <tr id="r_id_">
                                ...
                                <td scope="row">
                                    ...
                                    @if ($amountReceived_1_->send_accountant == 1)
                                        <a href="{{route('paradigms-apartments.collect.cancel.send.accountant',['id' => $amountReceived_1_->id, 'paradigm_id' => 2])}}" class="badge badge-danger "
                                ...
                                <td scope="row">
                                    <!-- </form>
                                    <form action="{{route('paradigms-people.house.collect.delete')}}"
                                    method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{route('paradigms-people.house.collect.delete',['id' => $amountReceived_1_->id])}}" class="badge badge-danger "
                                                onclick="if(!confirm('Bạn có chắc chắn muốn hủy ?')){return false}" >
                                            <i class="icon-cross"></i></a>
                                    @endif
