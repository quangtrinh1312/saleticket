    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="" class="breadcrumb-item">Kí túc xá</a>
    ...
    <div class="card mb-4">
        <div class="container mb-2">
            ...
            <div id="list_type_price_table">
                @include('admins.paradigms.dors.amount-received.type-price.pagination')
            </div>
...
<script>
    ...
    let routeStore = "{{ route('post.paradigms.dor.type.price') }}";
    let routeEdit = "{{ route('edit.paradigms.dor.type.price', ':id') }}";
    let routeUpdate = "{{ route('update.paradigms.dor.type.price', ':id') }}";
    let routeDestroy = "{{ route('destroy.paradigms.dor.type.price', ':id') }}";
    let routeGetRow = "{{ route('get.row.paradigms.dor.type.price') }}";
    let route = {
        store: routeStore,
        edit: routeEdit,
        update: routeUpdate,
