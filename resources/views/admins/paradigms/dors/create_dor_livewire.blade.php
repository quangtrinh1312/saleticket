<div>
    <div wire:ignore.self class="modal fade" id="modal_create_dor" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Tạo Ký túc xá:</h5>
...
@push('script')
<script>
    window.addEventListener('openCreateDor', () => {
        $('#modal_create_dor').modal('show');
    })

    window.addEventListener('closeCreateDor', () => {
        $('#modal_create_dor').modal('hide');
    })
</script>
@endpush