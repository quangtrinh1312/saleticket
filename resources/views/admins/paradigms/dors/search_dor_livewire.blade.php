        ...
        <form wire:submit.prevent="search">
            <div class="form-group">
                <div class="row align-items-center">
                    <div class="col-2">
                        <label for="apartment" class="float-right col-form-label">Tên Ký túc xá</label>
                    </div>
                    <div class="col-7">
                        <input type="text" name="name" class="form-control form-control-sm" wire:model.lazy="dorName">
