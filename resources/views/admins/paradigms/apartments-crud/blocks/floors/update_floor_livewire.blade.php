<div>
    <div wire:ignore.self class="modal fade" id="modal_update_floor" role="dialog" aria-labelledby="exampleModalLabel_update" aria-hidden="true">
                    ...
                    <form wire:submit.prevent="update">
                        <div class="row">
                            ...
                            <div class="col-3 mt-3">
                                <label for="block_id" class="col-form-label float-right">Nhà:</label>
                            </div>
...
<script>
    ...
    window.addEventListener('openUpdateFloor', () => {
        $('#modal_update_floor').modal('show');
    })

    window.addEventListener('closeUpdateFloor', () => {
        $('#modal_update_floor').modal('hide');
    })
