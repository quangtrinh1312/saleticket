    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                <a href="#!" class="breadcrumb-item">Tầng</a>
                <span class="breadcrumb-item active">Căn hộ</span>
...
<div class="content">
    <div class="card mb-4">
        <div class="container mb-2">
            <div class="mt-2">
                @livewire('rooms.search-room-livewire', ['paradigm_id' => $paradigm_id])
            </div>

            @livewire('rooms.list-room-livewire', ['paradigm_id' => $paradigm_id])

            @livewire('rooms.create-room-livewire', ['paradigm_id' => $paradigm_id])

            @livewire('rooms.update-room-livewire', ['paradigm_id' => $paradigm_id])

            @livewire('rooms.delete-room-livewire', ['paradigm_id' => $paradigm_id])
        </div>
    </div>
</div>
@endsection
