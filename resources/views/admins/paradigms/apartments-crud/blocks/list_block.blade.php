    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-lg-inline">
        <div class="d-flex">
            <div class="breadcrumb">
                ...
                @endif
                <span class="breadcrumb-item active">Nhà</span>
...
<div class="content">
    <div class="card mb-4">
        <div class="container mb-2">
            <div class="mt-2">
                @livewire('blocks.search-block-livewire', ['paradigm_id' => $paradigm_id])
            </div>

            @livewire('blocks.list-block-livewire', ['paradigm_id' => $paradigm_id])

            @livewire('blocks.create-block-livewire', ['paradigm_id' => $paradigm_id])

            @livewire('blocks.update-block-livewire', ['paradigm_id' => $paradigm_id])

            @livewire('blocks.delete-block-livewire', ['paradigm_id' => $paradigm_id])
        </div>
    </div>
</div>
@endsection
