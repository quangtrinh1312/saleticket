<div>
    <div wire:ignore.self class="modal fade" id="modal_update_apartment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel_update" aria-hidden="true">
...
@push('script')
<script>
    window.addEventListener('openUpdateApartment', () => {
        $('#modal_update_apartment').modal('show');
    })

    window.addEventListener('closeUpdateApartment', () => {
        $('#modal_update_apartment').modal('hide');
    })
</script>
@endpush