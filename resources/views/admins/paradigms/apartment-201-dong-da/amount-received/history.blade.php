        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.apartment.201.history',  ['paradigm_id' => 5])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
                            <div class="col-6">
                    ...
                    <table class="table table-hover table-dark table-striped mb-1 table-bordered">
                        ...
                        <tbody id="list_accountant_table_data">
                            ...
                            <tr id="r_id_">
                                ...
                                <td scope="row" class="text-center">{{$amountReceived_1_->send_accountant == 1 ? 'Đâ nộp' : ''}}</td>
                                <td scope="row" class="text-center">
...
<script type="">
    ...
    function getApartment(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-apartments.201.collect.edit','id')}}',
    ...
    function getDetail(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-apartments.201.collect.detail','id')}}',
