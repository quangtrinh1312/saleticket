        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.apartment.worker.housing.history',  ['paradigm_id' => 6])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
                            <div class="col-6">
...
<script type="">
    ...
    function getApartment(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-apartments.worker.housing.collect.edit','id')}}',
    ...
    function getDetail(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-apartments.worker.housing.collect.detail','id')}}',
