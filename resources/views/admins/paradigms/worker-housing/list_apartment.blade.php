        ...
        <div class="container mb-2">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('paradigms-apartments.index', ['url' => url()->full(), 'paradigm_id' => 1])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="form-group">
                            <div class="row align-items-center">
                                ...
                                <div class="col-7">
                                    <input type="text" name="name" id="apartment" value="{{isset($params['name']) ? $params['name'] : ''}}" class="form-control form-control-sm">
            ...
            <div id="list_apartment_table">
                @include('admins.paradigms.apartments.ajax_list_apartment')
            </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('paradigms-apartments.store', ['url' => url()->full(), 'paradigm_id' => 1])}}" method="POST">
                                @method('POST')
                                @csrf
                                <div class="row">
                                    <div class="col-3">
            ...
            <div class="modal fade" id="modal_update_apartment" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel_update" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel_update">Sửa Chung Cư</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
