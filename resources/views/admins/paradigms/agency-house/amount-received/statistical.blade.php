        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.agency.house.statistical', ['paradigm_id' => 3])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
            ...
            <a href="{{ route('get.paradigms.export.excel', ['paradigm_id' => 3, 'params' => $params]) }}" class="btn btn-success btn-sm">
            ...
            <div class="mt-1 row">
                <div class="col-lg-12">
                    ...
                    <form action="{{route('confirm.send.accountant.agency.house')}}" method="POST">
                    @method('POST')
                    @csrf
                    <input type="text" name="paradigm_id" value="{{$paradigm_id ?? 0}}" hidden>
                    ...
                    <table class="table table-hover table-dark table-striped mb-1 table-bordered">
                        ...
                        <tbody id="list_accountant_table_data">
                            ...
                            <tr id="r_id_">
                                ...
                                <td scope="row">
                                    <!-- </form>
                                    <form action="{{route('paradigms-agency.house.collect.delete')}}"
                                    method="POST">
                                        @csrf
                                        @method('DELETE')
                                    ...
                                    <a href="{{route('paradigms-agency.house.collect.delete',['id' => $amountReceived_1_->id])}}" class="badge badge-danger "
                                                onclick="if(!confirm('Bạn có chắc chắn muốn hủy ?')){return false}" >
                                            <i class="icon-cross"></i></a>
                                    @endif
