    ...
    <div class="card mb-4">
        <div class="container mb-2">
            ...
            <div id="list_type_price_table">
                @include('admins.paradigms.agency-house.amount-received.type-price.pagination')
            </div>
...
<script>
    ...
    let routeStore = "{{ route('post.paradigms.agency.house.type.price') }}";
    let routeEdit = "{{ route('edit.paradigms.agency.house.type.price', ':id') }}";
    let routeUpdate = "{{ route('update.paradigms.agency.house.type.price', ':id') }}";
    let routeDestroy = "{{ route('destroy.paradigms.agency.house.type.price', ':id') }}";
    let routeGetRow = "{{ route('get.row.paradigms.agency.house.type.price') }}";
    let route = {
        store: routeStore,
        edit: routeEdit,
        update: routeUpdate,
