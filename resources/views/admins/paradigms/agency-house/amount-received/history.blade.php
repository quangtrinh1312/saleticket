        ...
        <div class="container">
            <div class="mt-2">
                <fieldset class="scheduler-border">
                    ...
                    <form action="{{route('get.paradigms.agency.house.history', ['paradigm_id' => 3])}}" method="GET">
                        @method('GET')
                        @csrf
                        <div class="row">
...
<script type="">
    ...
    function getApartment(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-agency.house.collect.edit','id')}}',
    ...
    function getDetail(paradigm_id, id, url) {
        ...
        $.ajax({
            ...
            url: '{{route('paradigms-agency.house.collect.detail','id')}}',
